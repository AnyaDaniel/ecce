                    ...
                    <div className="row">
                        <div className="col col-lg-3 col-md-6 col-sm-12 col-12">
                            <div className="widget about-widget">
                                ...
                                <p>ECCE LAW is known for its client-centric approach and unwavering commitment to professionalism. We pride ourselves on delivering excellent and satisfactory legal service. </p>
                                <ul>
                                    <li>
                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col col-lg-6 col-md-12 col-12">
                            <ul>
                                <li>Copyright &copy; 2024 //  All Right Reserved by <Link onClick={ClickHandler} to="/">ECCE LAW.</Link></li>
                            </ul>
                        </div>
                        <div className="col col-lg-6 col-md-12 col-12">
                            {/* <div className="link">
